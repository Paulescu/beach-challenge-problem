...
class BamlSyncClient:
    ...
    def SolveProblem(self, problem: str,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="SolveProblem", args={
            "problem": problem,
        })
...
class BamlStreamClient:
    ...
    def SolveProblem(self, problem: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.ProblemSolution, types.ProblemSolution]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="SolveProblem", args={
            "problem": problem,
        })
        return baml_py.BamlSyncStream[stream_types.ProblemSolution, types.ProblemSolution](
          result,
...
class BamlHttpRequestClient:
    ...
    def SolveProblem(self, problem: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="SolveProblem", args={
            "problem": problem,
        }, mode="request")
        return result
